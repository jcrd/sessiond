...
This file configures the X session manager B<sessiond>(1). Its syntax is
toml v0.4.0. See: I<https://github.com/toml-lang/toml/tree/v0.4.0>.
...
B<sessiond>(1), B<systemd-logind>(8), B<sessiond-hooks>(5)
