...
session to B<systemd-logind>(8) and handles its lock, unlock, sleep, and
...
The B<org.sessiond.session1.Session> interface exposes the following methods,
...
List running inhibitors. Returns a list of tuples with the I<who> and I<why>
strings.

=item B<GetVersion>

Returns the version of sessiond.
...
Copyright 2018 James Reed. sessiond is licensed under the
GNU General Public License v3.0 or later.

=head1 SEE ALSO

B<sessiond.conf>(5), B<sessiond-hooks>(5), B<systemd-logind>(8), B<gdbus>(1)
